    ...
    render(){
        return(
            <View style={styles.container}>
              ...
              <View style={{marginTop:350,backgroundColor:'#F8BE85',}}>
              <FlatList
                keyExtractor={this.keyExtractor}
                data={list}
                renderItem={this.renderItem}
                style={{marginTop:50,backgroundColor:'#F8BE85',}}
              />
              </View>
              <View style={{marginBottom:100,backgroundColor:'#F8BE85',}}>
              <FlatList
                keyExtractor={this.keyExtractor1}
                data={list1}
                renderItem={this.renderItem1}
                style={{marginBottom:450,backgroundColor:'#F8BE85',}}
              />
              </View>
            </View>
        )
